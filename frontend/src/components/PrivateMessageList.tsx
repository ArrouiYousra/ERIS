...
export function PrivateMessageList() {
  ...
  //Need to handle new conversations and new messages on a conv

  //   const handleNewPrivateMessage = async (messageId: number) => {
  ...
  //Need to handle the deleting of a conversation

  return (
    <div className="flex flex-1 flex-col h-full bg-[#313338]">
      <div className="h-12 px-2 sm:px-4 flex items-center gap-2 border-b border-black/20 shadow-sm shrink-0 min-w-0">
        <h3 className="text-white font-semibold truncate">Messages privés</h3>
      </div>
  ...
  return (
    ...
    <div className="flex items-center gap-2 sm:gap-4 ml-auto">
      <div className="relative hidden sm:block">
        <input
          type="text"
          placeholder={`Rechercher dans conv`}
